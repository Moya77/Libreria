...
namespace ClientesWebService.DB
{
    ...
    public interface IQueryGetBookCode
    {
        public int GetBookCode(string name);
    }

    public class QueryGetBookCode : IQueryGetBookCode
    {
        ...
        public QueryGetBookCode(IConfiguration IConfiguration)
        {
        ...
        public int GetBookCode(string name)
        {
            Logger.Trace("Ejecucion del comando obtencion del codigo book");
            try
            {
                ...
                using (SqlConnection connection = new(_IConfiguration.GetConnectionString("Connection")))
                {
                    ...
                    using (SqlCommand cmd = new("GetBookCode", connection))//definicion del comando
                    {
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;//indicando procedimiento almacenado
                        cmd.Parameters.AddWithValue("@name_book", name);//configuracion de parametro
